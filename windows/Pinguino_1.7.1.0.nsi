...
!define INSTALLER_VERSION				'1.7.1.0'
...
Function InstallPinguino
    ...
    ;${if} $PINGUINO_VERSION = "11"
        ...
        Rename "$EXEDIR\update-$PINGUINO_RELEASE" "$INSTDIR\v$PINGUINO_VERSION\update-$PINGUINO_RELEASE"
...
Function MakeShortcuts
    ...
    ;Make shortcuts on desktop and start menu
...
Function InstallComplete
    ...
    ${if} $PINGUINO_VERSION = ${PINGUINO_TESTING}
        ...
        StrCmp $0 "0" Done
        Abort "Post-installation $(E_failed) $0!"
