...
!define INSTALLER_VERSION               '1.7.2.0'
!define PYTHON2_VERSION                 '2.7.13'
!define PYTHON3_VERSION                 '3.6.1'
...
!define REG_PYTHON36                    "SOFTWARE\Python\PythonCore\3.6\InstallPath"
...
Var /GLOBAL XC8_VERSION                 ; 1.40 for ex.
...
Function PAGE_RELEASE_LEAVE
    ...
    ${If} $R0 == 1
        ...
        ${Else}
            SetRegView 32
        ${endif}
        StrCpy $INSTDIR "C:\${PINGUINO_NAME}"
        ;DetailPrint "Installation path : $INSTDIR"
        StrCpy $UserPath "C:\${PINGUINO_NAME}\v$PINGUINO_VERSION"
...
Function InstallPython
    ...
    DetailPrint "Python $(msg_not_detected)"
    ...
    Done:
    DetailPrint "Python path is $0"
    DetailPrint "Python $(msg_installed)"
