...
;b4 : Regis Blanchot <rblanchot@pinguino.cc>
...
!define FILE_INSTVERSION '${FILE_VERSION}.1.1.4'
...
!define Python27 "python-2.7.10.msi"
...
LangString please_plug_in_your_board ${LANG_ENGLISH} "1-Connect your board to your PC"
...
LangString please_plug_in_your_board ${LANG_FRENCH} "1-Connectez votre carte Pinguino au PC"

LangString switch_to_bootloader_mode ${LANG_ENGLISH} "2-Switch to bootloader mode (see the Wiki for more info.)"
...
LangString switch_to_bootloader_mode ${LANG_FRENCH} "2-Passez en mode bootloader (voir le Wiki pour plus d'info.)"

LangString spot_the_pinguino_boards ${LANG_ENGLISH} "3-You'll be presented a list of USB Devices connected to your computer, spot and select your Pinguino board (Vendor ID 0x04D8 (Microchip), Product ID 0xFEAA (8-bit) and/or 0x003C (32-bit) and press OK to proceed the installation."
