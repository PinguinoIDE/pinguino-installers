...
#define PREFIX_CONF "/dvpt/pinguino/git-local/pinguino-installers/windows/NSIS/nsis-3.0b1/etc"
#define PREFIX_DATA "/dvpt/pinguino/git-local/pinguino-installers/windows/NSIS/nsis-3.0b1/share/nsis"
